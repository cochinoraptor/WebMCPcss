...
.hero h1 { font-size: clamp(32px, 5vw, 52px); line-height: 1.05; letter-spacing: -1px; max-width: 18ch; }
...
.detail-head h1 { font-size: clamp(26px, 4vw, 38px); letter-spacing: -.6px; }
...
.import code { background: transparent; padding: 0; }
...
.example li { display: flex; gap: 8px; align-items: center; justify-content: space-between; font-size: 13.5px; }
.example li code { flex: 1; overflow: auto; white-space: nowrap; }
...
@media (max-width: 860px) { .docs { grid-template-columns: 1fr; } .docs aside { position: static; } }
...
[data-preview-root] > * { max-width: 100%; }
